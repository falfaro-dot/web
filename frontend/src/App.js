        ...
        {activeView === 'admin' && (
          <div className="admin-section">
            ...
            <div className="section-card">
              ...
              <p className="warning-text">⚠️ Las acciones en esta sección requieren credenciales de administrador</p>
            ...
            <div className="section-card">
              ...
              <form onSubmit={handleCreateUser}>
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    <label>Email Nuevo Usuario</label>
                    <input
                      type="email"
                      value={newUserEmail}
              ...
              <div className="table-container">
                <table className="data-table">
                  ...
                  <tbody>
                    {users.length === 0 ? (
                      <tr>
                        <td colSpan="4" className="no-data">No hay usuarios cargados. Ingrese credenciales y presione "Cargar Usuarios".</td>
                      </tr>
                    ) : (
                      users.map((user, idx) => (
                        <tr key={idx}>
